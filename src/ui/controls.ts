...
export const CONTROLS: ControlDef[] = [
  ...
  {
    // Pillar spacing: from a sparse hall to a close colonnade.
    id: 'oracleRoom',
    name: 'Colonnade',
    glslName: 'uOracleRoom',
    min: 0,
    max: 1,
    step: 0.01,
    default: 0.4,
